...
import { FloatingPortal, useFloating, shift, arrow, offset } from '@floating-ui/react'
      ...
      <div className='container'>
          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-5 h-5 mr-2 flex-shrink-0'>
                <img
                  src='https://cf.shopee.vn/file/95f6da1e2aa98867df27033b130f8fb8_tn'
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-8 lg:h-11 w-full fill-white'>
              <g fillRule='evenodd'>
